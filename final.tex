...
\begin{figure}
	...
	\begin{equation}\label{getX}	
		\theta_1=\sin x^{-1} \left( \frac{y}{r} \right) \cdot 2
	\end{equation}
	\begin{equation}\label{theta1}	
		\theta_1=\sin x^{-1}\left(\frac{725}{1000} \right) \cdot 2 \approx 93^\circ
	\end{equation}	
...
\begin{figure}
	...
	\begin{equation}\label{get001X}	
		\theta_2=\sin x^{-1} \left( \frac{y}{r} \right) \cdot 2
	\end{equation}
	\begin{equation}\label{theta2}	
		\theta_2=\sin x^{-1} \left( \frac{375}{1000} \right) \cdot 2 \approx 44^\circ
	\end{equation}	
...
\begin{figure}
	...
	\begin{equation}\label{get0005X}	
		\theta_3=\sin x^{-1} \left( \frac{y}{r} \right) \cdot 2
	\end{equation}
	\begin{equation}\label{theta3}	
		\theta_3=\sin x^{-1} \left( \frac{195}{1000} \right) \cdot 2 \approx 23^\circ
	\end{equation}	
